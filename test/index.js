...
VotingContract = web3.eth.contract(abi).at("0x15b19a6d503cf4e4397f9f3e599eabdead311f01");
var accounts;
...
function voteForCandidate() {
  ...
  VotingContract.voteForCandidate(candidateName, {from: currentAccount, value: window.web3.toWei('1', 'ether'), gas:999999999}, function() {
